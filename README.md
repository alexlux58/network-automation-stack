...
**Note**: The `bootstrap` command in the wrapper script will regenerate the entire project, so you only need to run the initial `bash bootstrap_netmgmt_suite.sh` once.
